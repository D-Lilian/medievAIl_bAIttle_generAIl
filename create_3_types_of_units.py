...
class Unit:
    ...
    def __init__(self, name, team, hp, armor, attack, range, size, sight, speed, accuracy, reload, reload_time, x, y, order):
        ...
        self.order = order                  # ordres donnees par le gerenal
...
class Archer(Unit):
    def __init__(self, team, x, y):
        super().__init__(name = "Archer", team = team, hp = 30, armor = 0, attack = 4, range = 4, size = 1, sight = 6, speed = 0.96, accuracy = 0.8, reload_time = 2.0, x = x, y = y)

class Knight(Unit):
    def __init__(self, team, x, y):
        super().__init__(name = "Knight", team = team, hp = 100, armor = 2, attack = 10, range = 0, size = 1, sight = 4, speed = 1.35, accuracy = 1.0, reload_time = 1.8, x = x, y = y)

class Pikeman(Unit):
    def __init__(self, team, x, y):
        super().__init__(name = "Pikeman", team = team, hp = 55, armor = 0, attack = 4, range = 0, size = 1, sight = 4, speed = 1.0, accuracy = 1.0, reload_time = 3.0, x = x, y = y)
