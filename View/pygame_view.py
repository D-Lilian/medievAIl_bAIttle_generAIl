...
class PygameView:
    ...
    def _draw_ground(self):
        ...
        map_size_x = self.scenario.size_x
        map_size_y = self.scenario.size_y
        
        p1 = self.cart_to_iso(0, 0)
        p2 = self.cart_to_iso(map_size_x, 0)
        p3 = self.cart_to_iso(map_size_x, map_size_y)
        p4 = self.cart_to_iso(0, map_size_y)
